...
def red_report(z_in):
    ...
    print('---------------------------------------------------------')
    print('Age of Universe:   {:6.1f} Gyr'.format(uni_age))
    print('Age at Redshift:   {:6.1f} Gyr'.format(age_z))
    print('Light Travel Time: {:6.1f} Gyr'.format(age_light))
    print('Comoving Distance: {:6.1f} Mpc'.format(coradial))
    print('Comoving Volume:   {:6.2f} Gpc^3'.format(covol))
    print('Angular Size Dist: {:6.1f} Mpc'.format(size_ang))
    print('Luminosity Dist:   {:6.1f} Mpc'.format(lumdist))
